...
export default function DashboardMockup() {
  return (
    <div className="relative mx-auto w-full max-w-[614px] px-2">
      ...
      <div className="relative rounded-[26px] sm:rounded-[32px] bg-[#3e444c] p-3 sm:p-7.5 shadow-2xl border border-[#4e555e]">
        ...
        <div className="relative w-full rounded-[14px] sm:rounded-[18px] overflow-hidden bg-[#0c1015]">
          <Image
            ...
            width={570}
            height={270}
            className="w-full h-auto sm:h-[320px] object-cover block select-none"
            priority
            unoptimized
          />
        </div>
